...
# Usage: curl -fsSL <URL>/TaishanPi-3-Install_CN.sh | bash
...
GITCODE_ORG="TaishanPi-Rockchip"
GITCODE_BASE="https://github.com"
MANIFEST_BRANCH="TaishanPi-3-260402"
REPO_DOWNLOAD_URL="https://raw.githubusercontent.com/${GITCODE_ORG}/git-repo/refs/heads/main/repo"
MANIFEST_URL="${GITCODE_BASE}/${GITCODE_ORG}/manifest.git"

LFS_REPOS=(
    "external/camera_engine_rkaiq"
    "tools"
    "prebuilts/gcc/linux-x86/aarch64/arm-gnu-toolchain-13.2.Rel1-x86_64-aarch64-none-elf"
)
...
install_live_build() {
    ...
    git clone https://github.com/TaishanPi-Rockchip/live-build.git -b "debian/1%20230131" "$LIVE_BUILD_DIR" >> "$LOG_FILE" 2>&1 &
...
export REPO_URL="https://github.com/TaishanPi-Rockchip/git-repo"
